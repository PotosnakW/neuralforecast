...
pat_dataset.to_csv('../datasets/ohiot1dm_exog_9_day_test.csv', index=False)
...
av_mask.head()
av_mask.to_csv('../datasets/ohiot1dm_exog_9_day_test_avmask.csv', index=False)
...
static.to_csv('../datasets/ohiot1dm_static.csv', index=False)
