...
from .models.itransformert5 import iTransformerT5
...
class AutoMOMENT(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoMOMENT, self).__init__(
            cls_model=MOMENT,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
...
# %% ../nbs/models.ipynb 104
class AutoiTransformerT5(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoiTransformerT5, self).__init__(
            cls_model=iTransformerT5,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
...
class AutoPatchTSTMultivariate(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoPatchTSTMultivariate, self).__init__(
            cls_model=PatchTSTMultivariate,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
...
class AutoTimerXL(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoTimerXL, self).__init__(
            cls_model=TimerXL,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
...
class AutoCrossformer(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoCrossformer, self).__init__(
            cls_model=Crossformer,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
...
class AutoMOMENTFAST(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoMOMENTFAST, self).__init__(
            cls_model=MOMENTFAST,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
