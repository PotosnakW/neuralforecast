...
# %% auto 0
__all__ = ['PatchTST_backbone', 'Flatten_Head', 'TSTEncoder', 'PatchDecoder']
    ...
    def __init__(
        ...
        **trainer_kwargs
        ...
        if tokenizer_type == 'lags':
            ...
            stride=1
            padding_patch = None 
            assert input_size // lag == context_len, \
                f"Assertion failed: input_size // lag = {input_size // lag}, expected {context_len}"
