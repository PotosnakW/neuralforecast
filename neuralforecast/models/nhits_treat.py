# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/models.nhits_treat.ipynb.

# %% auto 0
__all__ = ['NHITS_TREAT']

# %% ../../nbs/models.nhits_treat.ipynb 5
...
# %% ../../nbs/models.nhits_treat.ipynb 8
...
# %% ../../nbs/models.nhits_treat.ipynb 10
class NHITS_TREAT(BaseWindows):
    """NHITS_TREAT
    ...
    **References:**<br>
    ...
    def __init__(
        ...
        **trainer_kwargs,
        ...
        super(NHITS_TREAT, self).__init__(
            h=h,
    ...
    def forward(self, windows_batch):
        ...
        for i, block in enumerate(self.blocks):
            if block.concentrator is not None:
                hist_exog_treat = block.concentrator(
