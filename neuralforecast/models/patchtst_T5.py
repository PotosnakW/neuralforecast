...
# %% auto 0
__all__ = ['Transpose', 'get_activation_fn', 'PatchTST_backbone', 'Flatten_Head', 'TSTiEncoder',
...
class TSTiEncoder(nn.Module):  # i means channel-independent
    ...
    def __init__(
        ...
        self.W_pos = PositionalEncoding(pe=pe).output(learn_pe, q_len, hidden_size)
    ...
    **References:**<br>
    ...
    def __init__(
        ...
        **trainer_kwargs
        ...
        d_k = hidden_size // n_heads #None  # Key dimension
        d_v = hidden_size // n_heads #None  # Value dimension
